...
namespace API.Middleware
{
    public class LogMiddleware
    {
        ...
        public async Task InvokeAsync(HttpContext httpContext, ILogger logger)
        {
            ...
            //httpContext.Request.Path.ToString().EndsWith(".html") || httpContext.Request.Path.ToString().EndsWith(".json");
            ...
            if (!isSwaggerRequest)
            {
                ...
                await logger.LogConsoleAsync($"{stringBuilder}");
            }
    ...
    {
        public static IApplicationBuilder UseLog(this IApplicationBuilder builder) => builder.UseMiddleware<LogMiddleware>();
    }
}